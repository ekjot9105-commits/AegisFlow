...
export default function GlobalFooter() {
  return (
    <footer className="w-full border-t border-white/10 bg-surfaceHighlight/30 backdrop-blur-md mt-auto z-40 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-extrabold tracking-widest text-white text-lg">AegisFlow</span>
            </div>
            ...
            <div className="flex items-center gap-4">
              <span className="text-[10px] font-mono text-textSecondary bg-surface/50 px-2 py-1 rounded border border-white/5">v2.0.0-rc</span>
          ...
          {/* Links Column 2 */}
          <div>
            <h3 className="text-xs font-bold text-white uppercase tracking-wider mb-4">Competition</h3>
            <ul className="space-y-2 text-sm text-textSecondary">
              <li>
                <a href="https://github.com/ekjot9105-commits/AegisFlow" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition-colors focus-visible:outline-none focus-visible:text-white focus-visible:underline">
                  <Code2 size={14} /> GitHub Repository
                </a>
              </li>
              <li>
                <a href="#" className="flex items-center gap-2 hover:text-white transition-colors focus-visible:outline-none focus-visible:text-white focus-visible:underline">
        ...
        <div className="mt-8 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[10px] text-textSecondary/60 text-center sm:text-left">
            &copy; 2026 AegisFlow Platform. Not officially affiliated with FIFA. Created for Google Prompt Wars.
          </p>
